...
const WIDTH, HEIGHT // stores constants of the canvas's width and height respectively
var game = {gameScale: 2, debug: false, gameState, subGameState}
var fps = {deltaTime, pastTime: 0, presentTime, framesPerSecond: 0, fpsSmoothing: 0.9}
var clock = {frameInterval, then, now, startTime, fpsCap, elapsed}
var menuBackgroundValues = {backgroundXPos1, backgroundXPos2}
var resourcePaths = [
...
function init() {
	...
	menuValues.backgroundXPos2 = WIDTH
	menuValues.backgroundXPos1 = 0
...
function main() {
	...
	fps.deltaTime = (presentTime - pastTime) / 1000
